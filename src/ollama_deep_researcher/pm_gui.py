...
class App:
    def __init__(self, root, data_dir=None):
        ...
        root.title('Research PM 0.6.2 - \uadfc\uac70 \uc911\uc2ec \uc5f0\uad6c\uc2e4')
        ...
        ttk.Label(outer, text='Research PM 0.6.2  |  원문을 쌓는 리서치 연구실', style='Title.TLabel').pack(anchor='w')
        ...
        self.efficiency_status=tk.StringVar(value='v0.6.2 / \uc2e4\uc81c \uc870\uc0ac \ud488\uc9c8\uc740 \uc6d0\ubb38\uc73c\ub85c \ud655\uc778\ud558\uc138\uc694.')
            ...
            if self.pid:
                ...
                if s.get('engine_version')==6:
                    self.efficiency_status.set(
                        f"v0.6.2 / {s['settings'].get('optimization_mode','balanced')} | "
